...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String requette="CREATE TABLE parcourt ( id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL , nom VARCHAR NOT NULL , idCinema VARCHAR NOT NULL , nomCinema VARCHAR NOT NULL, idRestaurant VARCHAR NOT NULL , nomRestaurant VARCHAR NOT NULL, dateCreation DATE NOT NULL , datePrevu DATE NOT NULL, accompagnant VARCHAR NOT NULL , status VARCHAR NOT NULL);";
